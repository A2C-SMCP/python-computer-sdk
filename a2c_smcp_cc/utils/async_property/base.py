# -*- coding: utf-8 -*-
# filename: async_property.py
# @Time    : 2025/8/18 17:06
# @Author  : JQQ
...
from a2c_smcp_cc.utils.async_property.proxy import AwaitableOnly
...
INVALID_ACTION = "Cannot {} @async_property. Use @async_cached_property instead."
